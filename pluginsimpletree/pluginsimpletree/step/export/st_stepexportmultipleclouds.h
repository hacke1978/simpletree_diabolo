...
#ifndef ST_STEPEXPORTMULTIPLECLOUDS
#define ST_STEPEXPORTMULTIPLECLOUDS
...
class ST_StepExportMultipleClouds: public CT_AbstractStep, public SimpleTreeStep
{
    Q_OBJECT
...
public:
     ...
     */
    ST_StepExportMultipleClouds(CT_StepInitializeData &dataInit);

    ~ST_StepExportMultipleClouds();
     ...
     */
    virtual ST_StepExportMultipleClouds* createNewInstance(CT_StepInitializeData &dataInit);
...
#endif // ST_STEPEXPORTMULTIPLECLOUDS
