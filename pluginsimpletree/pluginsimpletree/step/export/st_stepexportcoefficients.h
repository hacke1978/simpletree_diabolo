...
class ST_StepExportCoefficients: public CT_AbstractStep, public SimpleTreeStep
{
    Q_OBJECT
...
public:
     ...
     */
    ST_StepExportCoefficients(CT_StepInitializeData &dataInit);

    ~ST_StepExportCoefficients();
     ...
     */
    virtual ST_StepExportCoefficients* createNewInstance(CT_StepInitializeData &dataInit);
