#ifndef ST_STEPLOADSIMPLETREEMODEL_H
#define ST_STEPLOADSIMPLETREEMODEL_H
...
class ST_StepLoadSimpleTreeModel: public ST_StepAbstractModellingMT
{
    Q_OBJECT
...
public:
     ...
     */
    ST_StepLoadSimpleTreeModel(CT_StepInitializeData &dataInit);

    ~ST_StepLoadSimpleTreeModel();
...
#endif // ST_STEPLOADSIMPLETREEMODEL_H
