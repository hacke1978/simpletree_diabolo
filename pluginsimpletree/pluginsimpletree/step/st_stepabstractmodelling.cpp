...
ST_StepAbstractModelling::ST_StepAbstractModelling(CT_StepInitializeData &dataInit) : CT_AbstractStep(dataInit)
{
    _knn = 4;
    _species = "unknown";
    _id      = "unknown_001";
...
ST_StepAbstractModelling::~ST_StepAbstractModelling()
{
    _sceneList->clear();
    delete _sceneList;
}

void ST_StepAbstractModelling::receive_qstring_abstract_modelling(QString qstring)
{
...
void ST_StepAbstractModelling::receive_counter_abstract_modelling(int counter)
{
    setProgress(counter);
}
...
void ST_StepAbstractModelling::createInResultModelListProtected()
{
...
void ST_StepAbstractModelling::createOutResultModelListProtected()
{
...
void ST_StepAbstractModelling::add_cylinder_data(Tree tree, CT_ResultGroup *resCpy_res, CT_StandardItemGroup *grpCpy_grp, QString string)
{
...
CT_TTreeGroup *ST_StepAbstractModelling::constructTopology(const CT_AbstractResult *res_r, QSharedPointer<Tree> tree, QString string)
{
...
void ST_StepAbstractModelling::constructTopologyRecursively(const CT_AbstractResult *res_r, CT_TNodeGroup *parent, QSharedPointer<Segment> segment, QSharedPointer<Tree> tree, QString string)
{
...
void ST_StepAbstractModelling::setCylinders(const CT_AbstractResult *res_r, CT_TNodeGroup *root, QSharedPointer<Segment> segment, QSharedPointer<Tree> tree, QString string)
{
...
QMap<QString, FileCoefficients> ST_StepAbstractModelling::get_map()
{
...
void ST_StepAbstractModelling::build_tree_model(CT_ResultGroup *resCpy_res, CT_StandardItemGroup *grpCpy_grp)
{
    ...
    if(_percent_stem>05&&_percent_stem<90)
    {
    ...
    QSharedPointer<SphereFollowingRecursive> spherefollowing(new SphereFollowingRecursive (_cloud,coeff, true));

    QObject::connect(spherefollowing.data(), SIGNAL(emit_qstring_spherefollowingrecursive(QString)), this, SLOT(receive_qstring_abstract_modelling(QString)) );
    QObject::connect(spherefollowing.data(), SIGNAL(emit_counter_spherefollowingrecursive(int)), this, SLOT (receive_counter_abstract_modelling(int)) );
...
void ST_StepAbstractModelling::enrich_cloud(const CT_AbstractItemDrawableWithPointCloud *itemCpy_cloud_in, CT_ResultGroup* resCpy_res, CT_StandardItemGroup* grpCpy_grp)
{
...
void ST_StepAbstractModelling::create_simple_tree_cloud(const CT_AbstractItemDrawableWithPointCloud *itemCpy_cloud_in)
{
