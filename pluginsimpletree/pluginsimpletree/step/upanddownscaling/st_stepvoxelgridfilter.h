...
#ifndef ST_VOXELGRIDFILTER_H
#define ST_VOXELGRIDFILTER_H
...
class ST_StepVoxelGridFilter : public CT_AbstractStep, public SimpleTreeStep
{
    Q_OBJECT
...
public:
     ...
     */
    ST_StepVoxelGridFilter(CT_StepInitializeData &dataInit);

    ~ST_StepVoxelGridFilter();
