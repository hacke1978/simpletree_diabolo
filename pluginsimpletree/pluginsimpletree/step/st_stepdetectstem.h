...
#ifndef ST_STEPDETECTSTEM_H
#define ST_STEPDETECTSTEM_H
...
class ST_StepDetectStem : public CT_AbstractStep
{
    Q_OBJECT
...
public:
     ...
     */
    ST_StepDetectStem(CT_StepInitializeData &dataInit);
