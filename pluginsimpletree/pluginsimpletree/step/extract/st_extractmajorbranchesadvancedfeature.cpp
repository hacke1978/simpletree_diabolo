...
////            qDebug() << p.x << ";"  << p.y << ";" << p.z << ";" << p.eigen1 << ";" << p.eigen2 << ";" << p.eigen3 << ";"  << p.is_stem;
////        }
...
//                                              resCpy_res, PS_REPOSITORY->registerPointCloudIndex(extractedCloud)); // 3) create scene, registering the pointcloudindex
