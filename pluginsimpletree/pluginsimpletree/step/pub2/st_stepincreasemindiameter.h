...
#ifndef ST_STEPINCREASEDIAMETER
#define ST_STEPINCREASEDIAMETER
...
class ST_StepIncreaseDiameter: public CT_AbstractStep, public SimpleTreeStep
{
    Q_OBJECT
...
public:
     ...
     */
    ST_StepIncreaseDiameter(CT_StepInitializeData &dataInit);

    ~ST_StepIncreaseDiameter();
     ...
     */
    virtual ST_StepIncreaseDiameter* createNewInstance(CT_StepInitializeData &dataInit);
...
private:
    ...
    QVector<double> generate_min_radii();

    QSharedPointer<Tree> set_min_radius(QSharedPointer<Tree> tree, double radius);
...
public:
    ...
    double _min_rad = 0.00;

    double _max_rad = 0.05;

    double _increment = 0.01;
    CT_AutoRenameModels     _outCylinderGroupModelName;


};

#endif // ST_STEPINCREASEDIAMETER
