...
#ifndef ST_STEPBUFFERING_H
#define ST_STEPBUFFERING_H
...
class ST_StepBuffering : public CT_AbstractStep, public SimpleTreeStep
{
    Q_OBJECT
...
public:
     ...
     */
    ST_StepBuffering(CT_StepInitializeData &dataInit);
...
private:
    ...
    CT_AutoRenameModels    _cloud_out_target;
