...
#ifndef ST_STEPFILTERCLUSTERS_H
#define ST_STEPFILTERCLUSTERS_H
...
class ST_StepFilterClusters : public CT_AbstractStep, public SimpleTreeStep
{
    Q_OBJECT
...
public:
     ...
     */
    ST_StepFilterClusters(CT_StepInitializeData &dataInit);

    ~ST_StepFilterClusters();
