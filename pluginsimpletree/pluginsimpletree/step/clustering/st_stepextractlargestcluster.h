...
#ifndef ST_STEPEXTRACTLARGESTCLUSTER_H
#define ST_STEPEXTRACTLARGESTCLUSTER_H
...
class ST_StepExtractLargestCluster : public CT_AbstractStep, public SimpleTreeStep
{
    Q_OBJECT
...
public:
     ...
     */
    ST_StepExtractLargestCluster(CT_StepInitializeData &dataInit);

    ~ST_StepExtractLargestCluster();
...
private:
   ...
   // PointCloudS::Ptr _cloud_in;
    ...
    double _min_perc = 0.0f;



    // Declaration of autoRenames Variables (groups or items added to In models copies)
//    CT_AutoRenameModels    _cloud_in_normals;
//    CT_AutoRenameModels    _cloud_in_stem;
    CT_AutoRenameModels    _outScene_cluster;
    CT_AutoRenameModels    _outScene_rest;
...
#endif // ST_STEPEXTRACTLARGESTCLUSTER_H
