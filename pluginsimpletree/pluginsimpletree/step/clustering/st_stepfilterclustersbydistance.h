...
#ifndef ST_STEPFILTERCLUSTERSBYDISTANCE_H
#define ST_STEPFILTERCLUSTERSBYDISTANCE_H
...
class ST_StepFilterClustersByDistance : public CT_AbstractStep, public SimpleTreeStep
{
    Q_OBJECT
...
public:
     ...
     */
    ST_StepFilterClustersByDistance(CT_StepInitializeData &dataInit);

    ~ST_StepFilterClustersByDistance();
...
void recursiveRemoveGroupIfEmpty(CT_AbstractItemGroup *parent, CT_AbstractItemGroup *group) const;
    ...
    CT_AutoRenameModels    _filtered_cluster;
...
#endif // ST_STEPFILTERCLUSTERSBYDISTANCE_H
