...
#ifndef ST_STEPMERGECLOUDS_H
#define ST_STEPMERGECLOUDS_H
...
class ST_StepMergeClouds : public CT_AbstractStep, public SimpleTreeStep
{
    Q_OBJECT
...
public:
     ...
     */
    ST_StepMergeClouds(CT_StepInitializeData &dataInit);
...
private:
    ...
    CT_AutoRenameModels    _outScene_merge;


};
#endif // ST_STEPMERGECLOUDS_H
