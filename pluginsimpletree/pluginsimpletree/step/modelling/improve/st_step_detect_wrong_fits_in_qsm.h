...
#ifndef ST_STEP_DETECT_WRONG_FITS_QSM
#define ST_STEP_DETECT_WRONG_FITS_QSM
...
#include <SimpleTree4/method/computeallometrySave.h>
...
class ST_StepDetectWrongFitsInQSM: public CT_AbstractStep, public SimpleTreeStep
{
    Q_OBJECT
...
public:
     ...
     */
    ST_StepDetectWrongFitsInQSM(CT_StepInitializeData &dataInit);

    ~ST_StepDetectWrongFitsInQSM();
     ...
     */
    virtual ST_StepDetectWrongFitsInQSM* createNewInstance(CT_StepInitializeData &dataInit);
...
public:
    ...
    CT_AutoRenameModels     _outCylinderModelName_improved_by_allometry_bad;

    CT_AutoRenameModels _branchIDModelName_bad;
    CT_AutoRenameModels _branchOrderModelName_bad;
    CT_AutoRenameModels _segmentIDModelName_bad;
    CT_AutoRenameModels _parentSegmentIDModelName_bad;
    CT_AutoRenameModels _growthVolumeModelName_bad;
    CT_AutoRenameModels _tree_species_bad;
    CT_AutoRenameModels _tree_id_bad;
    CT_AutoRenameModels _detection_type_bad;
    CT_AutoRenameModels _improvement_type_bad;
    ...
    CT_AutoRenameModels     _outCylinderModelName_improved_by_allometry_stem;

    CT_AutoRenameModels _branchIDModelName_stem;
    CT_AutoRenameModels _branchOrderModelName_stem;
    CT_AutoRenameModels _segmentIDModelName_stem;
    CT_AutoRenameModels _parentSegmentIDModelName_stem;
    CT_AutoRenameModels _growthVolumeModelName_stem;
    CT_AutoRenameModels _tree_species_stem;
    CT_AutoRenameModels _tree_id_stem;
    CT_AutoRenameModels _detection_type_stem;
    CT_AutoRenameModels _improvement_type_stem;

    CT_AutoRenameModels     _topologyGroup;
    CT_AutoRenameModels     _stemGroup;
    CT_AutoRenameModels     _stemCylinders;

    double _min_rad = 0.005;

    double _percentage = 0.5;


    QString pype = "pype";
    QString growth_len = "growth_length";
    QString growth_vol = "growth_volume";
    QString _selected = pype;
};

#endif // ST_STEP_DETECT_WRONG_FITS_QSM
