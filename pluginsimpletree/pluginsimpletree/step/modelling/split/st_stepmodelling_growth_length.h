...
#ifndef ST_STEPMODELLINGGROWTHLENGTH
#define ST_STEPMODELLINGGROWTHLENGTH
...
class ST_StepModellingGrowthLength: public CT_AbstractStep, public SimpleTreeStep
{
    Q_OBJECT
...
public:
     ...
     */
    ST_StepModellingGrowthLength(CT_StepInitializeData &dataInit);

    ~ST_StepModellingGrowthLength();
     ...
     */
    virtual ST_StepModellingGrowthLength* createNewInstance(CT_StepInitializeData &dataInit);
...
#endif // ST_STEPMODELLINGGROWTHLENGTH
