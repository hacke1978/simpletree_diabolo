...
*****************************************************************************/
#include "st_stepmodelling_growth_length.h"
...
ST_StepModellingGrowthLength::ST_StepModellingGrowthLength(CT_StepInitializeData &dataInit) : CT_AbstractStep(dataInit)
{
}

ST_StepModellingGrowthLength::~ST_StepModellingGrowthLength()
{
}


// Step description (tooltip of contextual menu)
QString ST_StepModellingGrowthLength::getStepDescription() const
{
    return tr("QSM spherefollowing method - allometric correction  with GrowthLength.");
}

// Step detailled description
QString ST_StepModellingGrowthLength::getStepDetailledDescription() const
{
    return tr("This step peforms an allometric correction  with GrowthLength on a QSM model.");
}

// Step URL
QString ST_StepModellingGrowthLength::getStepURL() const
{
    return tr("http://www.simpletree.uni-freiburg.de/");
    //return CT_AbstractStep::getStepURL(); //by default URL of the plugin
}

QString ST_StepModellingGrowthLength::getStepName() const
{
    return "ST_QSM_Allometric_correction_advanced";
}

// Step copy method
ST_StepModellingGrowthLength* ST_StepModellingGrowthLength::createNewInstance(CT_StepInitializeData &dataInit)
{
    return new ST_StepModellingGrowthLength(dataInit);
}
...
void ST_StepModellingGrowthLength::createPostConfigurationDialog()
{
...
void ST_StepModellingGrowthLength::createInResultModelListProtected()
{
...
void ST_StepModellingGrowthLength::createOutResultModelListProtected()
{
...
void ST_StepModellingGrowthLength::add_cylinder_data(QSharedPointer<Tree> tree, CT_ResultGroup *resCpy_res, CT_StandardItemGroup *grpCpy_grp)
{
...
void ST_StepModellingGrowthLength::compute()
{
