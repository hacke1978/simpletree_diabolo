...
*****************************************************************************/
#include "st_stepallometrycorrected_qsm_len.h"
...
ST_StepAllometry_Corrected_QSM_len::ST_StepAllometry_Corrected_QSM_len(CT_StepInitializeData &dataInit) : CT_AbstractStep(dataInit)
{
    _min_rad = 0.05f;
}

ST_StepAllometry_Corrected_QSM_len::~ST_StepAllometry_Corrected_QSM_len()
{
}


// Step description (tooltip of contextual menu)
QString ST_StepAllometry_Corrected_QSM_len::getStepDescription() const
{
    return tr("QSM spherefollowing method - extrapolates by length everything smaller than a certain diameter.");
}

// Step detailled description
QString ST_StepAllometry_Corrected_QSM_len::getStepDetailledDescription() const
{
    return tr("QSM spherefollowing method - extrapolates by length everything smaller than a certain diameter.");
}

// Step URL
QString ST_StepAllometry_Corrected_QSM_len::getStepURL() const
{
...
// Step copy method
ST_StepAllometry_Corrected_QSM_len* ST_StepAllometry_Corrected_QSM_len::createNewInstance(CT_StepInitializeData &dataInit)
{
    return new ST_StepAllometry_Corrected_QSM_len(dataInit);
}
...
void ST_StepAllometry_Corrected_QSM_len::createPostConfigurationDialog()
{
...
void ST_StepAllometry_Corrected_QSM_len::createInResultModelListProtected()
{
...
void ST_StepAllometry_Corrected_QSM_len::createOutResultModelListProtected()
{
...
void ST_StepAllometry_Corrected_QSM_len::add_cylinder_data(QSharedPointer<Tree> tree, CT_ResultGroup *resCpy_res, CT_StandardItemGroup *grpCpy_grp)
{
...
void ST_StepAllometry_Corrected_QSM_len::compute()
{
