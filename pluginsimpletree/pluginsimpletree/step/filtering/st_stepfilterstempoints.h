...
#ifndef ST_STEPFILTERSTEMS
#define ST_STEPFILTERSTEMS
...
class ST_StepFilterStems : public CT_AbstractStep, public SimpleTreeStep
{
    Q_OBJECT
...
public:
     ...
     */
    ST_StepFilterStems(CT_StepInitializeData &dataInit);
...
private:
    ...
    CT_AutoRenameModels _stem_noise;
    CT_AutoRenameModels _stem_denoise;

};
#endif // ST_STEPFILTERSTEMS
