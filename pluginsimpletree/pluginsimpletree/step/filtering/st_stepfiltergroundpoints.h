...
#ifndef ST_STEPFILTERGROUNDPOINTS
#define ST_STEPFILTERGROUNDPOINTS
...
class ST_StepFilterGroundPoints : public CT_AbstractStep, public SimpleTreeStep
{
    Q_OBJECT
...
public:
     ...
     */
    ST_StepFilterGroundPoints(CT_StepInitializeData &dataInit);

    ~ST_StepFilterGroundPoints();
...
#endif // ST_STEPFILTERGROUNDPOINTS
