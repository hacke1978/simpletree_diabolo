...
#ifndef ST_STEPEXTRACTSTEM_H
#define ST_STEPEXTRACTSTEM_H
...
class ST_StepExtractStem : public CT_AbstractStep
{
    Q_OBJECT
...
public:
     ...
     */
    ST_StepExtractStem(CT_StepInitializeData &dataInit);
