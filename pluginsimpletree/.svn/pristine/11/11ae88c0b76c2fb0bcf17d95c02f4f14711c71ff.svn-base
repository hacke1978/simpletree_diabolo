...
#ifndef ST_STEPMODELWITHPARAM2
#define ST_STEPMODELWITHPARAM2
...
class ST_StepModelling2: public CT_AbstractStep, public SimpleTreeStep
{
    Q_OBJECT
...
public:
     ...
     */
    ST_StepModelling2(CT_StepInitializeData &dataInit);
     ...
     */
    virtual ST_StepModelling2* createNewInstance(CT_StepInitializeData &dataInit);
