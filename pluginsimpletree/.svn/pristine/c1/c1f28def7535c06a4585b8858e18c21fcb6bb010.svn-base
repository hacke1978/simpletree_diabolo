...
#ifndef ST_STEP_ADJUST_BRANCH_ORDER
#define ST_STEP_ADJUST_BRANCH_ORDER
...
class ST_StepAdjustBranchOrder: public CT_AbstractStep, public SimpleTreeStep
{
    Q_OBJECT
...
public:
     ...
     */
    ST_StepAdjustBranchOrder(CT_StepInitializeData &dataInit);

    ~ST_StepAdjustBranchOrder();
     ...
     */
    virtual ST_StepAdjustBranchOrder* createNewInstance(CT_StepInitializeData &dataInit);
...
#endif // ST_STEP_ADJUST_BRANCH_ORDER
