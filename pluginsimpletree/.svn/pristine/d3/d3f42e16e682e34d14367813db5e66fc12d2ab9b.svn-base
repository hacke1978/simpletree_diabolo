#ifndef ST_STEPABSTRACTMODELLINGMT_H
#define ST_STEPABSTRACTMODELLINGMT_H
...
struct SimpleTreeMT
{
    ...
    FileCoefficients file_coeff;
};

class ST_StepAbstractModellingMT: public CT_AbstractStep
{
    Q_OBJECT
     static QMutex lock;
...
public:
     ...
     */
    ST_StepAbstractModellingMT(CT_StepInitializeData &dataInit);

    ~ST_StepAbstractModellingMT();
    ...
    static QVector<SimpleTreeMT> st_mt_vec;

    void update_vec(int i, MethodCoefficients coeff, QVector<pcl::ModelCoefficients> cylinder_coeff) ;

public slots:

    void receive_counter_finished();
...
protected:
    ...
    QVector<SimpleTreeMT> _st_mt_object;
    QVector<PointCloudS::Ptr> _clouds;
    QVector<int> _percentages_stem;
...
//    CT_AutoRenameModels     _rootTreeGroup;
    ...
    void compute_start_params(MethodCoefficients coeff, PointCloudS::Ptr cloud);
};

#endif // ST_STEPABSTRACTMODELLINGMT_H
