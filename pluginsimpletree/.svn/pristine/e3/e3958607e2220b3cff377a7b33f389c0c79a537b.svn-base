...
#ifndef ST_STEPMODELMA
#define ST_STEPMODELMA
...
class ST_StepModelMa: public CT_AbstractStep
{
    Q_OBJECT
...
public:
     ...
     */
    ST_StepModelMa(CT_StepInitializeData &dataInit);
     ...
     */
    virtual ST_StepModelMa* createNewInstance(CT_StepInitializeData &dataInit);
...
public:
    ...
    CT_AutoRenameModels     _out_cylinder_grp;
    CT_AutoRenameModels    _attractor_stem;
    CT_AutoRenameModels    _spherefollowing_stem;
    CT_AutoRenameModels     _attractor_branch;
    CT_AutoRenameModels     _spherefollowing_branch;
