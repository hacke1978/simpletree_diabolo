...
#ifndef ST_STEPMODELWITHPYPE
#define ST_STEPMODELWITHPYPE
...
class ST_StepModellingImprovePype: public CT_AbstractStep, public SimpleTreeStep
{
    Q_OBJECT
...
public:
     ...
     */
    ST_StepModellingImprovePype(CT_StepInitializeData &dataInit);

    ~ST_StepModellingImprovePype();
     ...
     */
    virtual ST_StepModellingImprovePype* createNewInstance(CT_StepInitializeData &dataInit);
...
public:
    ...
    bool _complete_tree = false;



};

#endif // ST_STEPMODELWITHPYPE
