...
#ifndef MODELLINGTHREADPOOL_ERIC_H
#define MODELLINGTHREADPOOL_ERIC_H
...
class ModellingThreadPool_Eric:  public QThreadPool, public QEnableSharedFromThis<ModellingThreadPool_Eric>
{
    Q_OBJECT
    QVector<StepParameter_Eric> _params;

    int _number_cylinders_total = 0;
public:
    ModellingThreadPool_Eric(QVector<StepParameter_Eric> params);
...
#endif // MODELLINGTHREADPOOL_ERIC_H
