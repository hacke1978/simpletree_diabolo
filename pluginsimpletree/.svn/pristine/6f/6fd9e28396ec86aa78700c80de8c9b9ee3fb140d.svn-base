...
*****************************************************************************/
#include "st_stepmodelwithparam2.h"
...
ST_StepModelling2::ST_StepModelling2(CT_StepInitializeData &dataInit) : CT_AbstractStep(dataInit)
{

    // pcl::console::setVerbosityLevel(pcl::console::L_ALWAYS);
}

ST_StepModelling2::~ST_StepModelling2()
{
}


// Step description (tooltip of contextual menu)
QString ST_StepModelling2::getStepDescription() const
{
    return tr("QSM spherefollowing method - allometric correction  with GrowthVolume.");
}

// Step detailled description
QString ST_StepModelling2::getStepDetailledDescription() const
{
    return tr("This step peforms an allometric correction with GrowthVolume on a QSM model.");
}

// Step URL
QString ST_StepModelling2::getStepURL() const
{
...
// Step copy method
ST_StepModelling2* ST_StepModelling2::createNewInstance(CT_StepInitializeData &dataInit)
{
    return new ST_StepModelling2(dataInit);
}
...
void ST_StepModelling2::createPostConfigurationDialog()
{
...
void ST_StepModelling2::createInResultModelListProtected()
{
...
void ST_StepModelling2::createOutResultModelListProtected()
{
...
void ST_StepModelling2::add_cylinder_data(QSharedPointer<Tree> tree, CT_ResultGroup *resCpy_res, CT_StandardItemGroup *grpCpy_grp)
{
...
void ST_StepModelling2::compute()
{
