...
#ifndef ST_STEPEXPORTALL
#define ST_STEPEXPORTALL
...
#define DEF_SearchInHeaderResult "header_res"

class ST_StepExportAll: public CT_AbstractStep, public SimpleTreeStep
{
    Q_OBJECT
...
public:
     ...
     */
    ST_StepExportAll(CT_StepInitializeData &dataInit);
     ...
     */
    virtual ST_StepExportAll* createNewInstance(CT_StepInitializeData &dataInit);
...
private:
    ...
    bool _save_coefficients = false;
    bool _save_all = true;
    bool _save_ply = true;
    bool _save_cloud = false;
