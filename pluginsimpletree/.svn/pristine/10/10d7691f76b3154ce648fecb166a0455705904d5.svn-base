...
#ifndef WORKERMODELLING_ERIC_H
#define WORKERMODELLING_ERIC_H
...
class ModellingThreadPool_Eric;
class ST_StepCompleteFolderModelling_Eric;
class WorkerModelling_Eric: public QObject, public QRunnable, public SimpleTreeStep
{
    Q_OBJECT

public:
    WorkerModelling_Eric(StepParameter_Eric param, QSharedPointer<ModellingThreadPool_Eric> mtp);
...
private:
    ...
    QSharedPointer<ModellingThreadPool_Eric> _mtp;
