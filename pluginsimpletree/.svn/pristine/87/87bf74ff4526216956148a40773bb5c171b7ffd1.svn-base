...
#ifndef ST_STEPALLOMETRY_CORRECTED_QSM
#define ST_STEPALLOMETRY_CORRECTED_QSM
...
class ST_StepAllometry_Corrected_QSM: public CT_AbstractStep, public SimpleTreeStep
{
    Q_OBJECT
...
public:
     ...
     */
    ST_StepAllometry_Corrected_QSM(CT_StepInitializeData &dataInit);

    ~ST_StepAllometry_Corrected_QSM();
     ...
     */
    virtual ST_StepAllometry_Corrected_QSM* createNewInstance(CT_StepInitializeData &dataInit);
...
public:
    ...
    double _min_rad = 0.0025;



};

#endif // ST_STEPALLOMETRY_CORRECTED_QSM
