...
#ifndef ST_STEPALLOMETRY_CORRECTED_QSM_LEN
#define ST_STEPALLOMETRY_CORRECTED_QSM_LEN
...
class ST_StepAllometry_Corrected_QSM_len: public CT_AbstractStep, public SimpleTreeStep
{
    Q_OBJECT
...
public:
     ...
     */
    ST_StepAllometry_Corrected_QSM_len(CT_StepInitializeData &dataInit);

    ~ST_StepAllometry_Corrected_QSM_len();
     ...
     */
    virtual ST_StepAllometry_Corrected_QSM_len* createNewInstance(CT_StepInitializeData &dataInit);
...
#endif // ST_STEPALLOMETRY_CORRECTED_QSM_LEN
