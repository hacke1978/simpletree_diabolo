...
#ifndef ST_STEPCROPQSM
#define ST_STEPCROPQSM
...
class ST_StepCropQSM: public CT_AbstractStep, public SimpleTreeStep
{
    Q_OBJECT
...
public:
     ...
     */
    ST_StepCropQSM(CT_StepInitializeData &dataInit);
     ...
     */
    virtual ST_StepCropQSM* createNewInstance(CT_StepInitializeData &dataInit);
