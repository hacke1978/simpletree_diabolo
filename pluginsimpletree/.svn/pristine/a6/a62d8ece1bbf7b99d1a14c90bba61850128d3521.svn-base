...
#ifndef ST_STEPSTATISTICALOUTLIERREMOVAL
#define ST_STEPSTATISTICALOUTLIERREMOVAL
...
class ST_StepStatisticalOutlierRemoval : public CT_AbstractStep, public SimpleTreeStep
{
    Q_OBJECT
...
public:
     ...
     */
    ST_StepStatisticalOutlierRemoval(CT_StepInitializeData &dataInit);

    ~ST_StepStatisticalOutlierRemoval();
...
#endif // ST_STEPSTATISTICALOUTLIERREMOVAL
