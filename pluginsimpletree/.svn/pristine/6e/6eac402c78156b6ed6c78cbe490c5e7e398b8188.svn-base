...
#ifndef ST_STEPFITSINGLECYLINDER_H
#define ST_STEPFITSINGLECYLINDER_H
...
class ST_StepFitSingleCylinder : public CT_AbstractStep
{
    Q_OBJECT
...
public:
     ...
     */
    ST_StepFitSingleCylinder(CT_StepInitializeData &dataInit);

    ~ST_StepFitSingleCylinder();
...
#endif // ST_STEPFITSINGLECYLINDER_H
