...
#include "st_stepexportcoefficients.h"





ST_StepExportCoefficients::ST_StepExportCoefficients(CT_StepInitializeData &dataInit) : CT_AbstractStep(dataInit)
{
   // pcl::console::setVerbosityLevel(pcl::console::L_ALWAYS);
}

ST_StepExportCoefficients::~ST_StepExportCoefficients()
{
}


// Step description (tooltip of contextual menu)
QString ST_StepExportCoefficients::getStepDescription() const
{
    return tr("Exports a list of files to xyb format.");
}

// Step detailled description
QString ST_StepExportCoefficients::getStepDetailledDescription() const
{
...
// Step URL
QString ST_StepExportCoefficients::getStepURL() const
{
    return tr("http://www.simpletree.uni-freiburg.de/");
}

// Step copy method
ST_StepExportCoefficients* ST_StepExportCoefficients::createNewInstance(CT_StepInitializeData &dataInit)
{
    return new ST_StepExportCoefficients(dataInit);
}
...
void ST_StepExportCoefficients::createPostConfigurationDialog()
{
...
void ST_StepExportCoefficients::createInResultModelListProtected()
{
...
void ST_StepExportCoefficients::createOutResultModelListProtected()
{
    CT_OutResultModelGroupToCopyPossibilities *resCpy_res = createNewOutResultModelToCopy(DEFin_res);
}

void ST_StepExportCoefficients::compute()
{
...
void ST_StepExportCoefficients::exportPoints(QDataStream &stream,
