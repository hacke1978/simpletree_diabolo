...
#ifndef ST_STEPSEGMENTION2_H
#define ST_STEPSEGMENTION2_H
...
class ST_StepSegmentation2 : public CT_AbstractStep
{
    Q_OBJECT
...
public:
     ...
     */
    ST_StepSegmentation2(CT_StepInitializeData &dataInit);

    ~ST_StepSegmentation2();
