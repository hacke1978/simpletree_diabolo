...
#ifndef ST_STEPGHOSTPOINTREMOVAL
#define ST_STEPGHOSTPOINTREMOVAL
...
class ST_StepGhostPointRemoval : public CT_AbstractStep, public SimpleTreeStep
{
    Q_OBJECT
...
public:
     ...
     */
    ST_StepGhostPointRemoval(CT_StepInitializeData &dataInit);

    ~ST_StepGhostPointRemoval();
...
private:
    ...
    int _knn = 6;
    double _thresh = 0.05f;


    CT_AutoRenameModels    _outScene_spr;
...
#endif // ST_STEPGHOSTPOINTREMOVAL
