...
#ifndef ST_STEPCLEARSKY
#define ST_STEPCLEARSKY
...
class ST_StepClearSky : public CT_AbstractStep, public SimpleTreeStep
{
    Q_OBJECT
...
public:
     ...
     */
    ST_StepClearSky(CT_StepInitializeData &dataInit);
...
private:
    ...
    PointCloudS::Ptr _cloud_out_denoised;

    CT_AutoRenameModels _scene_sky_denoised;
    CT_AutoRenameModels _scene_sky_noise;

};
#endif // ST_STEPCLEARSKY
