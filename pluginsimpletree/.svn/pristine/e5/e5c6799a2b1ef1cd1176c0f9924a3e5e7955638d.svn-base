#ifndef ST_STEPCOMPLETEMODELLINGFOLDER_H
#define ST_STEPCOMPLETEMODELLINGFOLDER_H
...
class ST_StepCompleteModellingFolder: public CT_AbstractStep
{
    Q_OBJECT
...
public:
     ...
     */
    ST_StepCompleteModellingFolder(CT_StepInitializeData &dataInit);

    ~ST_StepCompleteModellingFolder();
...
#endif // ST_STEPCOMPLETEMODELLINGFOLDER_H
