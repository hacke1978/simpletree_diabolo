...
#ifndef ST_STEPRADIUSOUTLIERREMOVAL
#define ST_STEPRADIUSOUTLIERREMOVAL
...
class ST_StepRadiusOutlierRemoval : public CT_AbstractStep, public SimpleTreeStep
{
    Q_OBJECT
...
public:
     ...
     */
    ST_StepRadiusOutlierRemoval(CT_StepInitializeData &dataInit);

    ~ST_StepRadiusOutlierRemoval();
...
private:
    ...
    CT_AutoRenameModels    _outScene_ror;
...
#endif // ST_STEPRADIUSOUTLIERREMOVAL
