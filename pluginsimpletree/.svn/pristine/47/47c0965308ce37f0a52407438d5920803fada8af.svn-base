...
#ifndef ST_STEPSEGMENTION3_H
#define ST_STEPSEGMENTION3_H
...
class ST_StepSegmentationExtract : public CT_AbstractStep
{
    Q_OBJECT
...
public:
     ...
     */
    ST_StepSegmentationExtract(CT_StepInitializeData &dataInit);

    ~ST_StepSegmentationExtract();
...
private:
    ...
    void add_cluster( const CT_AbstractItemDrawableWithPointCloud *itemCpy_cloud_in, CT_ResultGroup *resCpy_res, CT_StandardItemGroup *grpCpy_grp);

    void enrich_cloud
    (const CT_AbstractItemDrawableWithPointCloud *itemCpy_cloud_in, CT_ResultGroup* resCpy_res, CT_StandardItemGroup* grpCpy_grp);

    PointCloudS::Ptr _cloud_in_source;
    PointCloudS::Ptr _cloud_in_target;
    ...
    CT_AutoRenameModels    _cloud_out;
